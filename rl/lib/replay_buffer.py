...
class ReplayBuffer:
    ...
    def sample_steps(self, n, fraction_best):
        ...
        if fraction_best != 1:
            final_sequences, total_rewards = self.sample_episodes_randomly(n_samples_random)
    ...
    def check_in_distribution_with_generated_actions(self, query_states, num_actions, device):
        """
...
# memory.create_prefix_dict()

# print(memory.prefix_dict)
